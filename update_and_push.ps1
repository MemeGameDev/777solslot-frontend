# update_and_push.ps1
# Replaces frontend/script.js and frontend/DEPLOY_README.md, commits and pushes to git.
# Usage: powershell -ExecutionPolicy Bypass -File update_and_push.ps1

$ErrorActionPreference = "Stop"

# === EDIT PATH IF NEEDED ===
$frontendPath = "C:\Users\maldi\Desktop\SOLOTOMANIA_CLEAN\frontend"
...
# Write script.js (backup if exists)
$scriptPath = Join-Path $frontendPath "script.js"
if (Test-Path $scriptPath) {
  Copy-Item $scriptPath ($scriptPath + ".bak") -Force
  Write-Host "Backed up existing script.js to script.js.bak"
}
Set-Content -Path $scriptPath -Value $scriptJs -Encoding UTF8
Write-Host "Wrote script.js"

# === DEPLOY_README.md content ===
$readme = @'
