      ...
      <div id="app-root" className="app-root">
        <header className="header-row">
          <div className="title-block">
            <h1 className="title">777 Sol Slot</h1>
        ...
        <main className="main-grid">
          ...
          <section className="center-col">
            <div className="stats-row">
              <div className="stat-card holders-card">
            ...
            <div className="panel machine-panel" id="machine-panel" style={{position:'relative', overflow:'visible'}}>
            ...
            <div className="controls-panel">
              ...
              <div id="register-note" className="result-text register-note">Register the holder wallet to Play</div>
            </div>
          </section>
        </main>
